  ...
  return (
    <CardsContainer>
      ...
      <CharacterInfo>
        ...
        <StatusCard>{props.isAlive} - {props.species}</StatusCard>
        </DivIcon>
        <LastLocation>Ultima vez visto:</LastLocation>
        <DescriptionLastLocation> {props.lastLocation ? props.lastLocation: "" }</DescriptionLastLocation>
        <FirstSeeIn>Primeira Vez visto:</FirstSeeIn>
        <DescriptionFirstSeeIn>{props.firstSeeIn ? props.firstSeeIn : "" }</DescriptionFirstSeeIn>
      </CharacterInfo>
    </CardsContainer>
  );
};
